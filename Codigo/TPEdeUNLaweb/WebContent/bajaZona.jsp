   ...
   <div class="row">
    ...
    <div class="col-lg-8 col-md-8 col-sm-12 right">
       <div class="form-group">
         <input type="text" class="form-control form-control-lg" placeholder="Nombre de la Zona" id="nombreZonaBaja">
       <INPUT id="eliminarZona" type="button" class="btn btn-secondary btn-block"
					value="Eliminar" />
    </div>
   </div>
   </div>
