   ...
   <div class="row">
    ...
    <div class="col-lg-8 col-md-8 col-sm-12 right">
       <div class="form-group">
         ...
         <input type="text" class="form-control form-control-lg" placeholder="Fecha de Inicio : dia/mes/año" id="fechaDesde">
         <input type="text" class="form-control form-control-lg" placeholder="Fecha de Fin : dia/mes/año" id="fechaHasta">
